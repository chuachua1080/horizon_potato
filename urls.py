...
urlpatterns = patterns('',
    ...
    url(r'^pro/(?P<pro_id>\d+)/info$','potato.pro.info'),
    url(r'^pro/(?P<pro_id>\d+)/edit$','potato.pro.edit'),
    url(r'^pro/(?P<pro_id>\d+)/edit_db$','potato.pro.edit_db'),
    url(r'^pro/(?P<pro_id>\d+)/remove$','potato.pro.remove'),
    url(r'^(?P<pro_id>\d+)/top/create$','potato.top.create'),
    (r'^(?P<pro_id>\d+)/top/(?P<top_id>\d+)/show$','potato.top.show'),
